				...
				<!-- Main -->
					<article id="main">
						<header>
							...
							$new_delivery = mysqli_query($dbcon, "INSERT INTO Delivery (Pin, Volunteer_ID, Organization_ID, Box_ID, Weight) 
                                                          VALUES('".$pin."', '".$volunteer_id."', '".$organization_id."', '".$box_id."', '".$weight."')");
                            ?>
